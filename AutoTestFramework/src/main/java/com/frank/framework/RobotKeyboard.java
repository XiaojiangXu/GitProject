...
public class RobotKeyboard {
  ...
  //提供字符串的输入
    ...
    public void typeKey(String p_string,int p_times) {
       ...
       else if (p_string.equalsIgnoreCase("F5"))
    	   doTypeKey(KeyEvent.VK_F5, p_times);
       else if (p_string.equalsIgnoreCase("PgUp"))
    	   doTypeKey(KeyEvent.VK_PAGE_UP, p_times);
       else if (p_string.equalsIgnoreCase("PgDn"))
    	   doTypeKey(KeyEvent.VK_PAGE_DOWN, p_times);
  ...
  //提供字符的输入
    ...
    public void uploadFile(String p_path) throws Exception{
    	StringSelection sel = new StringSelection(p_path);
		// 把路径复制粘贴到剪切板
