...
public class CreateScheduleApp {
	...
	public void testcase_CreateSchedule() throws Exception {
		...
		bussinessLibAndroid.createSchedule("日程_徐天", "天津", "ML0九期", p_assigntoList, "01", "02","不重复","否");
		CommonLib.sleep(DataStore.D_Wait_MediumTime);
		bussinessLibAndroid.newVerifyEquals("VP_CreateScheduleApp", "日程_徐天",bussinessLibAndroid.newElements(VPStore.VP_ScheduleApp));
